...
import './edit.component.less'
@Component({
    selector: 'my-operate',
    templateUrl: 'src/app/edit/edit.component.html'
})
export class EditComponent implements OnInit {
    ...
    getContacts() {
        this._constactService.getContactsData().subscribe((data: any) => {
            this.contacts = data;
        });
    }
    ...
    getContactDetailById(id: number) {
        ...
        if (ss_contacts) {
            ...
            this._constactService.getContactById(id).subscribe((data: any) => {
                this.contact = data;
            });
        }
    }
